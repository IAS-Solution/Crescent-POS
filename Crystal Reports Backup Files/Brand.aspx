<%@ Page Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Brand.aspx.cs" Inherits="Crescent_POS.Brand" %>
            ...
            <div class="row">
              ...
              <div class="col-md-6"> 
                <div class="form-group">
                  <label>Brand</label>
                    <asp:TextBox ID="txtFullName" runat="server" Class="form-control" placeholder="Brand"></asp:TextBox>
                </div><!-- /.form-group -->
              </div><!-- /.col -->
